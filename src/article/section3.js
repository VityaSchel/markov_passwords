...
export default function Section3() {
  return (
    <section id='protection'>
      ...
      <p>
        В конце прошу вас проголосовать в этом опросе. Также благодарю всех, кто помогал мне делать эту статью, написанную всего за сутки,
        слушая мое нытье в лс. Например, Федор Четвергов, который просил не упомянать его здесь. Я и не буду :)
      </p>
