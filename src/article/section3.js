    ...
    <section id='protection'>
      ...
      <ol>
        ...
        <li>
          <div className={globalStyles.marker} />
          <div>
            <b>Еще одно предложение: не использовать аккаунты гугл вообще.</b> А зачем они? Почта сейчас есть у
            каждого ученика, лично меня никто не заставлял пользоваться почтой СамЛИТа при участии в конкурсах. Для
            этого, конечно, нужно начать предоставлять доступ по ftp.
          </div>
        </li>
      </ol>
      <p>
      ...
      <p>
        ...
        как Марков сказал, что будет писать заявление в полицию. Благими намерениями вымощена дорога в ад :)
      </p>
      <p>
        <b>UPD Jul 2021:</b> В статье НЕ СОДЕРЖИТСЯ персональных данных ни одного человека, кроме меня и публичных данных
        Маркова. Если вы собираетесь со мной судиться — удачи, у вас ничего не выйдет.
      </p>
